...
import { CalendarArrowDown , Menu, X, Home, ClipboardList, User, Gift,  Twitter} from 'lucide-react'
...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    const navItems = [
      ...
      { icon: Twitter, text: 'Social Edit', path: '/socialplatform' },
      {icon: User, text: 'User Edit', path: '/useredit'},
      {icon: CalendarArrowDown, text: 'Orders', path: '/orders'}
    ]
